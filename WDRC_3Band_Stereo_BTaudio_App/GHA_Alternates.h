...
BTNRH_WDRC::CHA_DSL dsl_fullon = {5,  // attack (ms)
  ...
  {35.0, 35.0, 35.0,    34., 34., 34., 34., 34.},   // expansion-end kneepoint.  not relevant when there is no expansion or compression.
  {35.f, 35.f, 35.f,     20.f, 20.f, 20.f, 20.f, 20.f},   // compression-start gain.  Tweak these values up until it sounds bad!
