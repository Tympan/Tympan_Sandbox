//
// AudioEffectFreqLoweringFD_F32.h
//
...
//
// Created: Chip Audette, Open Audio, October 2020
//
// MIT License.  Use at your own risk.
//

#ifndef _AudioEffectFreqLoweringFD_F32_h
#define _AudioEffectFreqLoweringFD_F32_h
...
class AudioEffectFreqLoweringFD_F32 : public AudioStream_F32
{
  public:
    //constructors...a few different options.  The usual one should be: AudioEffectFreqLoweringFD_F32(const AudioSettings_F32 &settings, const int _N_FFT)
    AudioEffectFreqLoweringFD_F32(void) : AudioStream_F32(1, inputQueueArray_f32) {};
    AudioEffectFreqLoweringFD_F32(const AudioSettings_F32 &settings) :
      AudioStream_F32(1, inputQueueArray_f32) {
      sample_rate_Hz = settings.sample_rate_Hz;
    }
    AudioEffectFreqLoweringFD_F32(const AudioSettings_F32 &settings, const int _N_FFT) :
      AudioStream_F32(1, inputQueueArray_f32) {
      setup(settings, _N_FFT);
    }

    //destructor...release all of the memory that has been allocated
    ~AudioEffectFreqLoweringFD_F32(void) {
...
void AudioEffectFreqLoweringFD_F32::update(void)
{
...
void AudioEffectFreqLoweringFD_F32::processAudioFD_NL_vocode(float32_t *comples_2N_buffer, int fftSize) { //define some variables
  ...
  float dest_freq_Hz, source_freq_Hz, source_ind_float, interp_fac;
  float new_mag, scale;
  float orig_mag[N_2];
