...
//Extern Functions
extern void playSdWavFile(int index);
extern void stopSdWav(void);      
...
void SerialManager::printHelp(void) {  
  ...
  Serial.println("    1:  SD WAV: Play tone at 125 Hz");
  Serial.println("    2:  SD WAV: Play tone at 250 Hz");
  Serial.println("    3:  SD WAV: Play tone at 500 Hz");
  Serial.println("    4:  SD WAV: Play tone at 1000 Hz");
  Serial.println("    5:  SD WAV: Play tone at 2000 Hz");
  Serial.println("    x:  SD WAV: Stop playing the tone.");
