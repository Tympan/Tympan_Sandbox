...
AudioConnection_F32       patchCord2(noiseReduction, 0, i2s_out, 0);  //connect the algorithm to the left output
AudioConnection_F32       patchCord3(noiseReduction, 0, i2s_out, 1);  //connect the algorithm to the right output
